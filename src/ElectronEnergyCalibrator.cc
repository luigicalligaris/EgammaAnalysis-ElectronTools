...
void ElectronEnergyCalibrator::calibrate(SimpleElectron &electron)
{
    ...
    switch (correctionsType_){
        ...
        case 2: 
            ...
            if (dataset_=="Fall11"||dataset_=="Jan16ReReco") { 

                if (isEB && fabs(eta)<1 && r9<0.94) dsigMC = 0.0096;
                if (isEB && fabs(eta)<1 && r9>=0.94) dsigMC = 0.0074;
                if (isEB && fabs(eta)>=1 && r9<0.94) dsigMC = 0.0202;
                if (isEB && fabs(eta)>=1 && r9>=0.94) dsigMC = 0.0136;
                if (!isEB && fabs(eta)<2 && r9<0.94) dsigMC = 0.0255;
                if (!isEB && fabs(eta)<2 && r9>=0.94) dsigMC = 0.0255;
                if (!isEB && fabs(eta)>=2 && r9<0.94) dsigMC = 0.0267;
                if (!isEB && fabs(eta)>=2 && r9>=0.94) dsigMC = 0.0274;
